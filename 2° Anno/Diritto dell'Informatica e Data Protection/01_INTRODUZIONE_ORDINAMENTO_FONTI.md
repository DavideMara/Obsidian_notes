...
L'**Ordinamento Giuridico** è definito come un sistema intrinsecamente flessibile, capace di adattarsi, ma vincolato al rispetto assoluto della Costituzione. Analogamente, la **Norma Giuridica** deve possedere il requisito della costituzionalità (deve "stare sotto" la Costituzione). Il contenuto della norma si identifica con il precetto legale stesso.

> [!INFO] Principio di Abrogazione
> Le norme preesistenti (vecchie) vengono abrogate nelle parti non compatibili con le nuove disposizioni o con la Costituzione stessa.
...
### 2. Ordinamento e Leggi Nazionali
...
* **Decreto Legge (d.l):** Atto straordinario di necessità e urgenza adottato dal Governo. Deve essere convertito in legge dal Parlamento (entro 60 giorni) per non perdere efficacia sin dall'inizio (*ex tunc*).
...
### 3. Unione Europea
L'Italia aderisce formalmente all'Unione Europea tramite i trattati (TUE e TFUE). Le fonti del diritto dell'Unione si distinguono principalmente in:
